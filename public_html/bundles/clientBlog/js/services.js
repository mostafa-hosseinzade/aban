...
factory('Salt', ['$resource', function($resource) {
    ...
    return $resource('http://localhost:8000/app/:username/salt', {username:'@id'});
}]).
...
factory('Hello', ['$resource', 'TokenHandler', function($resource, tokenHandler) {
    var resource = $resource('/pet-project/web/app_dev.php/api/hello');
    resource = tokenHandler.wrapActions(resource, ['get']);
    return resource;
}]).
factory('Todos', ['$resource', 'TokenHandler', function($resource, tokenHandler){
    var resource = $resource('/pet-project/web/app_dev.php/api/todos', {}, { 
...
factory('Todo', ['$resource', 'TokenHandler', function($resource, tokenHandler){
    var resource = $resource('/pet-project/web/app_dev.php/api/todo', {}, { 
        update: {method:'PUT'},
    });
