...
//                console.log(entity);
                ...
                $scope.count = 0;
                $scope.selectedItem = {};
                $scope.action = entity[$scope.entity].action;
//                console.log($scope.action);
                $scope.ShowEdit = keyExists("edit", $scope.action);
                $scope.ShowDelete = keyExists("delete", $scope.action);
                $scope.ShowAdd = keyExists("add", $scope.action);
                $scope.ShowInfo = keyExists("show", $scope.action);
                $scope.ShowSearch = keyExists("search", $scope.action);
...
//                        console.log($scope.content);
    ...
    $http.get(BaseUrlAdmin + 'ShowNewAnimals').success(function(response) {
        if (response.animale != undefined) {
