...
angular.module('myApp', ['myApp.controllers', 'myApp.directives']).
        config(['$routeProvider', function ($routeProvider) {
                ...
                $routeProvider.when('/check-mobile/:mobile', {templateUrl: '../bundles/app/partials/check-mobile.html', controller: 'checkMobile'});
...
angular.module('myApp.controllers', [])
        ...
        .controller('resset', ['$scope', '$http', '$window', function ($scope, $http, $window) {
                ...
                $scope.onSubmit = function () {
                    ...
                    $http({
                        ...
                        }else if(response.mobile != undefined){
                            $window.location = '#/check-mobile/' + response.mobile;
                        }
                        $scope.isLoading = 0;
                        $scope.login = 'بازیابی کلمه عبور';
                    });
        ...
        .controller('checkMobile', ['$scope', '$routeParams', function ($scope, $routeParams) {
